...
class _FVP_All extends React.Component<IProps, IDataTableState>{
                ...
                onClick={
                  () => {
                    this._service.getItemById('FVP', row['ID']).then(item => {
                      // console.log("item.BUSegument is "+ JSON.parse(item.BUSegment).join(','));
                      // console.log("item.VisitorType is "+ item.VisitorType);
                      var copyitem =
                      {
      ...
      <>
        <div>
          {/* <Grid container justify="flex-end">
            <Typography className={classes.viewtitle} variant='subtitle2'>All FVPs</Typography>
          </Grid> */}
...
export default withStyles(styles)(_FVP_All);