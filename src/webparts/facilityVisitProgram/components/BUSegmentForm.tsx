...
class BUSegmentForm extends React.Component<FormProps> {
    ...
    private onSubmit = (values, { setSubmitting, resetForm }) => {
        ...
        setTimeout(() => {
            ...
            if (values.ID != null) {
                ...
                this._service.updateItem("BUSegment", v, Number(values.ID)).then(() => { this.props.refreshData(); });
            }
            else {

                this._service.createItem("BUSegment", values).then(() => { this.props.refreshData(); });
                ...
                <Paper>
                    ...
                    >
                        {({ errors, handleSubmit, touched, values, handleReset, isSubmitting }) => (
                            <form id="BUSegmentForm" className={classes.root} autoComplete="off" onReset={() => { handleReset(); }} onSubmit={handleSubmit} >
                                <Grid container>
...
export default withStyles(styles)(BUSegmentForm);
