...
class RoleForm extends React.Component<FormProps> {
    private _service: service;
    private initialValues: RoleItem;
    ...
    private onSubmit = (values, { setSubmitting, resetForm }) => {
        ...
        setTimeout(() => {
            ...
            if (values.ID != null) {
                ...
                this._service.updateItem("Role", v, Number(values.ID)).then(() => { this.props.refreshData(); });
            }
            else
                this._service.createItem("Role", values).then(() => { this.props.refreshData(); });
            resetForm();
                ...
                <Paper>
                    ...
                    >
                        {({ errors, handleSubmit, touched, values, handleReset, isSubmitting }) => (
                            <form id="RoleForm" className={classes.root} autoComplete="off" onReset={() => { handleReset(); }} onSubmit={handleSubmit} >
                                <Grid container>
